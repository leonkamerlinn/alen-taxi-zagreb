export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      // ClickShield backend origin — the browser posts the requestId straight here.
      clickshieldIngestUrl: '', // NUXT_PUBLIC_CLICKSHIELD_INGEST_URL (e.g. https://clickshield-web-...run.app)
    },
  },
